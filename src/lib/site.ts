export const site = {
  ...
  founded: "2024",
  socials: [
    { label: "Instagram", href: "https://instagram.com/orviqo" },
    { label: "LinkedIn", href: "https://linkedin.com/company/orviqo" },
    { label: "X", href: "https://x.com/orviqo" },
  ],
};
...
export const nav = {
  ...
  menu: [
    ...
    { label: "Careers", href: "/careers/", hint: "the bench" },
